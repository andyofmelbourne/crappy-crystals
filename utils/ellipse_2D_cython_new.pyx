...
def project_2D_Ellipse_arrays_cython_test(np.ndarray[Ctype_float, ndim=1] x, 
    ...
    cdef double Ii, Wxi, Wyi, s0, s1, s, ratio0, ratio1, g, n0, n1, r0, r1, xp0, yp0
    ...
    for ii in range(ii_max):
        ...
        if mask[ii] == 0 or (Wxi < tol and Wyi < tol):
            u[ii] = x[ii]
            v[ii] = y[ii]
            continue
